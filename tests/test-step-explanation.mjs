...
const auditedUniquenessCases = [
  {
    ...
    step: base({
      ...
      groups: [
        { label: "Branch:External Test + XY-Wing", cells: [] },
    ...
    guideZh: ["两个翼格中的1至少有一个为真", "1是共同删数数字，不是致命数字"],
  },
  {
    ...
    step: base({
      ...
      groups: [
        { label: "Branch:External Test 1", cells: [] },
        { label: "URBody:27", cells: [c(0), c(8), c(18), c(26)] },
  ...
  },
  {
    ...
    step: base({
      ...
      groups: [
        { label: "Branch:AUR + WXYZ-Ring", cells: [] },
        { label: "URBody:27", cells: [c(0), c(8), c(18), c(26)] },
...
const phase1BranchCases = [
  ...
  ["BUG+n Type 1", base({ kind: "BUGPlusN", title: "BUG + 2", description: "BUG + 2 Type 1: => r1c1<>12", candidates: [3, 4], actions: [], eliminations: [elim(0, [1, 2])], groups: [{ label: "Branch:Type 1", cells: [] }, { label: "Guardian:34", cells: [c(0)] }] }), "同一格"],
  ["BUG+n Type 2", base({ kind: "BUGPlusN", title: "BUG + 2", description: "BUG + 2 (Type 2): => r1c3<>5", candidates: [5], actions: [], eliminations: [elim(2, [5])], groups: [{ label: "Branch:Type 2", cells: [] }, { label: "Guardian:5", cells: [c(0)] }, { label: "Guardian:5", cells: [c(1)] }] }), "同数字"],
  ["BUG+n cross guardian generic branch", base({ kind: "BUGPlusN", title: "BUG + 2", description: "BUG + 2: => r1c1<>7,r1c2<>3", candidates: [3, 7], actions: [], eliminations: [elim(0, [7]), elim(1, [3])], groups: [{ label: "Branch:Cross-Guardian", cells: [] }, { label: "Guardian:3", cells: [c(0)] }, { label: "Guardian:7", cells: [c(1)] }] }), "守护集合至少一真"],
  ["BUG+n Type 3", base({ kind: "BUGPlusN", title: "BUG + 3", description: "BUG + 3 Type 3: With Naked Triple (237) => r1c9<>7", candidates: [2, 3, 7], actions: [], eliminations: [elim(8, [7])], groups: [{ label: "Branch:Type 3", cells: [] }, { label: "Guardian:2", cells: [c(0)] }, { label: "Guardian:3", cells: [c(1)] }, { label: "Subset:237", cells: [c(2), c(3)] }] }), "裸数组"],
  ["BUG+n Type 4", base({ kind: "BUGPlusN", title: "BUG + 2", description: "BUG + 2 (Type 4): => r1c1<>3,r1c2<>3", candidates: [2, 3, 7], actions: [], eliminations: [elim(0, [3]), elim(1, [3])], groups: [{ label: "Branch:Type 4", cells: [] }, { label: "Guardian:7", cells: [c(0)] }, { label: "Guardian:7", cells: [c(1)] }, { label: "StrongLink:2", cells: [c(0), c(1)] }] }), "共轭"],

  ["Avoidable Rectangle Type 1", base({ kind: "AvoidableRectangle", title: "Avoidable Rectangle Type 1", description: "Avoidable Rectangle Type 1: 2/7 in r13c19 => r3c9<>27", candidates: [2, 7], cells: [c(0), c(8), c(18), c(26)], actions: [], eliminations: [elim(26, [2, 7])], groups: [{ label: "Branch:Type 1", cells: [] }, { label: "ARBody:27", cells: [c(0), c(8), c(18), c(26)] }, { label: "SolvedCorners:27", cells: [c(0), c(8), c(18)] }, { label: "TargetCorner:27", cells: [c(26)] }] }), "三个已填非提示角"],
  ["Avoidable Rectangle Type 2", base({ kind: "AvoidableRectangle", title: "Avoidable Rectangle Type 2", description: "Avoidable Rectangle Type 2: 2/7 in r13c19 => r2c4<>1", candidates: [2, 7], cells: [c(0), c(8), c(18), c(26)], actions: [], eliminations: [elim(12, [1])], groups: [{ label: "Branch:Type 2", cells: [] }, { label: "ARBody:27", cells: [c(0), c(8), c(18), c(26)] }, { label: "SolvedCorners:27", cells: [c(0), c(8)] }, { label: "Roof:1", cells: [c(18), c(26)] }] }), "两个未解屋顶角"],

  ["UR Type 1", base({ kind: "UniqueRectangle", title: "Unique Rectangle Type 1", description: "Uniqueness Test 1: 2/7 in r13c19 => r3c9<>27", candidates: [2, 7], cells: [c(0), c(8), c(18), c(26)], actions: [], eliminations: [elim(26, [2, 7])], groups: [{ label: "Branch:Unique Rectangle Type 1", cells: [] }, { label: "URBody:27", cells: [c(0), c(8), c(18), c(26)] }, { label: "ExitCell:1", cells: [c(26)] }] }), "一个破坏格"],
  ["UR Type 2", base({ kind: "UniqueRectangle", title: "Unique Rectangle Type 2", description: "Uniqueness Test 2: 2/7 in r13c19 => r2c4<>1", candidates: [2, 7], cells: [c(0), c(8), c(18), c(26)], actions: [], eliminations: [elim(12, [1])], groups: [{ label: "Branch:Unique Rectangle Type 2", cells: [] }, { label: "URBody:27", cells: [c(0), c(8), c(18), c(26)] }, { label: "ExitCells:1", cells: [c(18), c(26)] }] }), "共享一个至少一真的额外数字"],
  ["UR Type 5", base({ kind: "UniqueRectangle", title: "Unique Rectangle Type 5", description: "Uniqueness Test 5: 2/7 in r13c19 => r2c4<>1", candidates: [2, 7], cells: [c(0), c(8), c(18), c(26)], actions: [], eliminations: [elim(12, [1])], groups: [{ label: "Branch:Unique Rectangle Type 5", cells: [] }, { label: "URBody:27", cells: [c(0), c(8), c(18), c(26)] }, { label: "ExitCells:1", cells: [c(0), c(26)] }] }), "共享一个至少一真的额外数字"],
  ["UR Type 3", base({ kind: "UniqueRectangle", title: "Unique Rectangle Type 3", description: "Uniqueness Test 3: 2/7 in r13c19 => r1c4<>1", candidates: [2, 7], cells: [c(0), c(8), c(18), c(26), c(3)], actions: [], eliminations: [elim(3, [1])], groups: [{ label: "Branch:Unique Rectangle Type 3", cells: [] }, { label: "URBody:27", cells: [c(0), c(8), c(18), c(26)] }, { label: "ExitCells:13", cells: [c(18), c(26)] }, { label: "NakedSubset:123", cells: [c(3)] }] }), "裸数组"],
  ["UR Type 4", base({ kind: "UniqueRectangle", title: "Unique Rectangle Type 4", description: "Uniqueness Test 4: 2/7 in r13c19 => r3c19<>7", candidates: [2, 7], cells: [c(0), c(8), c(18), c(26)], actions: [], eliminations: [elim(18, [7]), elim(26, [7])], groups: [{ label: "Branch:Unique Rectangle Type 4", cells: [] }, { label: "URBody:27", cells: [c(0), c(8), c(18), c(26)] }, { label: "ExitCells:13", cells: [c(18), c(26)] }, { label: "ConjugateExit:2", cells: [c(18), c(26)] }] }), "共轭对"],
  ["UR Type 6", base({ kind: "UniqueRectangle", title: "Unique Rectangle Type 6", description: "Uniqueness Test 6: 2/7 in r13c19 => r1c19<>2", candidates: [2, 7], cells: [c(0), c(8), c(18), c(26)], actions: [], eliminations: [elim(0, [2]), elim(8, [2])], groups: [{ label: "Branch:Unique Rectangle Type 6", cells: [] }, { label: "URBody:27", cells: [c(0), c(8), c(18), c(26)] }, { label: "ExitCells:13", cells: [c(0), c(8)] }, { label: "ConfinedDeadly:2", cells: [c(0), c(8)] }] }), "外部落点被清空"],
  ["UR Type 7", base({ kind: "UniqueRectangle", title: "Unique Rectangle Type 7", description: "Uniqueness Test 7: 2/7 in r13c19; 2 strong links + 1 bivalue => r1c1<>7,S-Ring:=>r2c1<>2", candidates: [2, 7], cells: [c(0), c(8), c(18), c(26)], actions: [], eliminations: [elim(0, [7]), elim(9, [2])], groups: [{ label: "Branch:Unique Rectangle Type 7", cells: [] }, { label: "URBody:27", cells: [c(0), c(8), c(18), c(26)] }, { label: "UR7", cells: [c(0), c(8), c(18), c(26)] }] }), "S-Ring"],
  ["Hidden Rectangle", base({ kind: "UniqueRectangle", title: "Hidden Rectangle", description: "Hidden Rectangle: 2/7 in r13c19 => r3c9<>7", candidates: [2, 7], cells: [c(0), c(8), c(18), c(26)], actions: [], eliminations: [elim(26, [7])], groups: [{ label: "Branch:Hidden Rectangle", cells: [] }, { label: "URBody:27", cells: [c(0), c(8), c(18), c(26)] }, { label: "HiddenLock:2", cells: [c(0), c(26)] }, { label: "TargetCorner:7", cells: [c(26)] }] }), "隐藏锁定"],
  ...
  ["AUR + XY-Wing", base({ kind: "UniqueRectangle", title: "AUR + XY-Wing", description: "AUR + XY-Wing: 2/7UR in r13c19; extra candidates -{1/3} + r2c4\\r3c4 construct a XY-Wing => r1c4<>1", candidates: [1], cells: [c(0), c(8), c(18), c(26), c(12), c(21)], actions: [], eliminations: [elim(3, [1])], groups: [{ label: "Branch:AUR + XY-Wing", cells: [] }, { label: "URBody:27", cells: [c(0), c(8), c(18), c(26)] }, { label: "Guardians:13", cells: [c(18), c(26)] }, { label: "WingA:12", cells: [c(12)] }, { label: "WingB:13", cells: [c(21)] }] }), "经Wing传到共同数字1"],
  ["AUR + XYZ-Wing", base({ kind: "UniqueRectangle", title: "AUR + XYZ-Wing", description: "AUR + XYZ-Wing: 2/7UR in r13c19; extra candidates -{1/3/4} + r2c4\\r3c4 construct a XYZ-Wing => r1c4<>1", candidates: [1], cells: [c(0), c(8), c(18), c(26), c(12), c(21)], actions: [], eliminations: [elim(3, [1])], groups: [{ label: "Branch:AUR + XYZ-Wing", cells: [] }, { label: "URBody:27", cells: [c(0), c(8), c(18), c(26)] }, { label: "Guardians:134", cells: [c(18), c(26)] }, { label: "WingA:12", cells: [c(12)] }, { label: "WingB:13", cells: [c(21)] }] }), "经Wing传到共同数字1"],
  ["AUR + WXYZ-Wing", base({ kind: "UniqueRectangle", title: "AUR + WXYZ-Wing", description: "AUR + WXYZ-Wing: 2/7UR in r13c19 => r1c4<>1", candidates: [1, 2, 7, 8], cells: [c(0), c(8), c(18), c(26), c(12), c(21), c(23)], actions: [], eliminations: [elim(3, [1])], groups: [{ label: "Branch:AUR + WXYZ-Wing", cells: [] }, { label: "URBody:27", cells: [c(0), c(8), c(18), c(26)] }, { label: "Guardians:18", cells: [c(18), c(26)] }, { label: "WXYZPivot:12", cells: [c(12)] }, { label: "WXYZWings:1278", cells: [c(21), c(23)] }] }), "WXYZ待定数组"],
  ["AUR + WXYZ-Ring", base({ kind: "UniqueRectangle", title: "AUR + WXYZ-Ring", description: "AUR + WXYZ-Ring: 2/7UR in r13c19 => r1c4<>1", candidates: [1, 2, 7, 8], cells: [c(0), c(8), c(18), c(26), c(12), c(21), c(23)], actions: [], eliminations: [elim(3, [1])], groups: [{ label: "Branch:AUR + WXYZ-Ring", cells: [] }, { label: "URBody:27", cells: [c(0), c(8), c(18), c(26)] }, { label: "Guardians:18", cells: [c(18), c(26)] }, { label: "WXYZPivot:12", cells: [c(12)] }, { label: "WXYZWings:1278", cells: [c(21), c(23)] }] }), "WXYZ待定数组/闭环"],

  ["UET 1", base({ kind: "UniqueRectangle", title: "Uniqueness External Test 1", description: "Uniqueness External Test 1: 2/7r13c19 => r1c2<>4", candidates: [4], cells: [c(0), c(8), c(18), c(26), c(1)], actions: [], eliminations: [elim(1, [4])], groups: [{ label: "Branch:External Test 1", cells: [] }, { label: "URBody:27", cells: [c(0), c(8), c(18), c(26)] }, { label: "Guardians:27", cells: [c(1)] }] }), "唯一外部守护格"],
  ["UET 2/4", base({ kind: "UniqueRectangle", title: "Uniqueness External Test 2/4", description: "Uniqueness External Test 2/4: 2/7 in r13c19 => r2c4<>7", candidates: [7], cells: [c(0), c(8), c(18), c(26), c(1), c(5)], actions: [], eliminations: [elim(12, [7])], groups: [{ label: "Branch:External Test 2/4", cells: [] }, { label: "URBody:27", cells: [c(0), c(8), c(18), c(26)] }, { label: "Guardians:7", cells: [c(1), c(5)] }] }), "没有外部守护"],
  ["UET 3", base({ kind: "UniqueRectangle", title: "Uniqueness External Test 3", description: "Uniqueness External Test 3: 2/7 in r13c19 => r1c4<>1", candidates: [2, 7], cells: [c(0), c(8), c(18), c(26), c(1), c(3)], actions: [], eliminations: [elim(3, [1])], groups: [{ label: "Branch:External Test 3", cells: [] }, { label: "URBody:27", cells: [c(0), c(8), c(18), c(26)] }, { label: "Guardians:27", cells: [c(1)] }, { label: "NakedSubset:127", cells: [c(3)] }] }), "裸数组共同锁定"],
  ["UET 3H", base({ kind: "UniqueRectangle", title: "Uniqueness External Test 3H", description: "Uniqueness External Test 3H: 2/7r13c19 + 1r1 => r1c4<>4", candidates: [1, 2, 7], cells: [c(0), c(8), c(18), c(26), c(1), c(3)], actions: [], eliminations: [elim(3, [4])], groups: [{ label: "Branch:External Test 3H", cells: [] }, { label: "URBody:27", cells: [c(0), c(8), c(18), c(26)] }, { label: "Guardians:27", cells: [c(1)] }, { label: "HiddenSubset:1", cells: [c(3)] }] }), "隐性数组共同锁定"],
  ["UET + XY-Wing", auditedUniquenessCases[0].step, "两个双值翼格"],

  ["Unique Loop Type 1", base({ kind: "UniqueLoop", title: "UL", description: "UL Type 1:r1c16,r2c68,r3c18 => r2c6<>13", candidates: [1, 3], cells: [c(0), c(5), c(14), c(16), c(18), c(25)], actions: [], eliminations: [elim(14, [1, 3])], groups: [{ label: "Branch:Type 1", cells: [] }, { label: "ULBody:13", cells: [c(0), c(5), c(14), c(16), c(18), c(25)] }, { label: "ExitCell:9", cells: [c(14)] }] }), "一个破坏格"],
  ["Unique Loop Type 2", base({ kind: "UniqueLoop", title: "UL", description: "UL Type 2: r3c79,r5c78,r9c89 => r78c7,r4c9<>9", candidates: [3, 4], cells: [c(24), c(26), c(42), c(43), c(79), c(80)], actions: [], eliminations: [elim(60, [9])], groups: [{ label: "Branch:Type 2", cells: [] }, { label: "ULBody:34", cells: [c(24), c(26), c(42), c(43), c(79), c(80)] }, { label: "ExitCells:9", cells: [c(42), c(80)] }] }), "共享一个至少一真的额外数字"],
  ["Unique Loop Type 3", base({ kind: "UniqueLoop", title: "UL", description: "UL Type 3: {r3c78,r7c68,r8c67}(With Naked Triple:235) => r6c6<>235", candidates: [4, 6], cells: [c(24), c(25), c(59), c(61), c(69), c(70)], actions: [], eliminations: [elim(50, [2, 3, 5])], groups: [{ label: "Branch:Type 3", cells: [] }, { label: "ULBody:46", cells: [c(24), c(25), c(59), c(61), c(69), c(70)] }, { label: "ExitCells:235", cells: [c(59), c(69)] }, { label: "NakedSubset:235", cells: [c(14), c(41), c(59), c(69)] }] }), "裸数组"],
  ["Unique Loop Type 4", auditedUniquenessCases[4].step, "共轭对"],

  ["Extended Rectangle Type 1", base({ kind: "ExtendedRectangle", title: "Extended Rectangle", description: "Extended Rectangle Type 1: 345r249c45 => r4c5<>45", candidates: [3, 4, 5], cells: [c(12), c(13), c(30), c(31), c(75), c(76)], actions: [], eliminations: [elim(31, [4, 5])], groups: [{ label: "Branch:Type 1", cells: [] }, { label: "XRBody:345", cells: [c(12), c(13), c(30), c(31), c(75), c(76)] }, { label: "ExitCell:6", cells: [c(31)] }] }), "一个破坏格"],
  ["Extended Rectangle Type 2", base({ kind: "ExtendedRectangle", title: "Extended Rectangle", description: "Extended Rectangle Type 2: 369r46c247 => r4c1<>4", candidates: [3, 6, 9], cells: [c(28), c(31), c(46), c(49), c(64), c(67)], actions: [], eliminations: [elim(27, [4])], groups: [{ label: "Branch:Type 2", cells: [] }, { label: "XRBody:369", cells: [c(28), c(31), c(46), c(49), c(64), c(67)] }, { label: "ExitCells:4", cells: [c(28), c(46)] }] }), "共享一个至少一真的额外数字"],
  ["Extended Rectangle Type 3", auditedUniquenessCases[5].step, "裸数组"],
  ["Extended Rectangle Type 4", base({ kind: "ExtendedRectangle", title: "Extended Rectangle", description: "Extended Rectangle Type 4: 123r27c456 With conjugate pair 2r7c45 in r7 => r7c4<>1,r7c5<>3", candidates: [1, 2, 3], cells: [c(12), c(13), c(14), c(57), c(58), c(59)], actions: [], eliminations: [elim(57, [1]), elim(58, [3])], groups: [{ label: "Branch:Type 4", cells: [] }, { label: "XRBody:123", cells: [c(12), c(13), c(14), c(57), c(58), c(59)] }, { label: "ConjugateExit:2", cells: [c(57), c(58)] }] }), "共轭对"],
];
...
const phase2FoundationCases = [
  ...
  ["X-Wing", base({ kind: "XWing", title: "X-Wing", candidates: [6], cells: [c(0), c(4), c(36), c(40)], actions: [], eliminations: [elim(13, [6])], groups: [{ label: "Branch:Standard", cells: [] }, { label: "Base:r15", cells: [c(0), c(4), c(36), c(40)] }, { label: "Cover:c15", cells: [] }, { label: "FishBody:6", cells: [c(0), c(4), c(36), c(40)] }] }), "一一占满全部覆盖区域"],
  ["Swordfish", base({ kind: "Swordfish", title: "Swordfish", candidates: [7], cells: [c(0), c(4), c(27), c(31), c(54), c(58)], actions: [], eliminations: [elim(13, [7])], groups: [{ label: "Branch:Standard", cells: [] }, { label: "Base:r147", cells: [] }, { label: "Cover:c159", cells: [] }, { label: "FishBody:7", cells: [c(0), c(4), c(27), c(31), c(54), c(58)] }] }), "抢掉一个已经必须留给基准真数的位置"],
  ["Jellyfish", base({ kind: "Jellyfish", title: "Jellyfish", candidates: [8], cells: [c(0), c(4), c(18), c(22), c(45), c(49), c(63), c(67)], actions: [], eliminations: [elim(13, [8])], groups: [{ label: "Branch:Standard", cells: [] }, { label: "Base:r1368", cells: [] }, { label: "Cover:c1598", cells: [] }, { label: "FishBody:8", cells: [c(0), c(4), c(18), c(22), c(45), c(49), c(63), c(67)] }] }), "抢掉一个已经必须留给基准真数的位置"],
  ["Finned X-Wing", base({ kind: "FinnedXWing", title: "Finned X-Wing", candidates: [5], cells: [c(0), c(4), c(9), c(13), c(14)], actions: [], eliminations: [elim(5, [5])], groups: [{ label: "Branch:Finned", cells: [] }, { label: "Base:r12", cells: [] }, { label: "Cover:c15", cells: [] }, { label: "FishBody:5", cells: [c(0), c(4), c(9), c(13)] }, { label: "Fin:5", cells: [c(14)] }, { label: "FinBox:b2", cells: [] }] }), "分两案看"],
  ["Finned Swordfish", base({ kind: "FinnedSwordfish", title: "Finned Swordfish", candidates: [9], cells: [c(0), c(4), c(8), c(27), c(31), c(54), c(58)], actions: [], eliminations: [elim(17, [9])], groups: [{ label: "Branch:Finned", cells: [] }, { label: "Base:r147", cells: [] }, { label: "Cover:c159", cells: [] }, { label: "FishBody:9", cells: [c(0), c(4), c(27), c(31), c(54), c(58)] }, { label: "Fin:9", cells: [c(8)] }, { label: "FinBox:b3", cells: [] }] }), "同一个鳍宫"],
  ["Finned Jellyfish", base({ kind: "FinnedJellyfish", title: "Finned Jellyfish", candidates: [4], cells: [c(0), c(4), c(8), c(27), c(31), c(54), c(58), c(72), c(76)], actions: [], eliminations: [elim(17, [4])], groups: [{ label: "Branch:Finned", cells: [] }, { label: "Base:r1479", cells: [] }, { label: "Cover:c1597", cells: [] }, { label: "FishBody:4", cells: [c(0), c(4), c(27), c(31), c(54), c(58), c(72), c(76)] }, { label: "Fin:4", cells: [c(8)] }, { label: "FinBox:b3", cells: [] }] }), "Branch=Finned"],
  ["Sashimi X-Wing", base({ kind: "FinnedXWing", title: "Sashimi X-Wing", candidates: [5], cells: [c(0), c(4), c(9), c(14)], actions: [], eliminations: [elim(5, [5])], groups: [{ label: "Branch:Sashimi", cells: [] }, { label: "Base:r12", cells: [] }, { label: "Cover:c15", cells: [] }, { label: "FishBody:5", cells: [c(0), c(9), c(13)] }, { label: "Fin:5", cells: [c(14)] }, { label: "FinBox:b2", cells: [] }] }), "Sashimi只表示"],
  ["Sashimi Swordfish", base({ kind: "FinnedSwordfish", title: "Sashimi Swordfish", candidates: [9], cells: [c(0), c(8), c(27), c(31), c(54), c(58)], actions: [], eliminations: [elim(17, [9])], groups: [{ label: "Branch:Sashimi", cells: [] }, { label: "Base:r147", cells: [] }, { label: "Cover:c159", cells: [] }, { label: "FishBody:9", cells: [c(0), c(27), c(31), c(54), c(58)] }, { label: "Fin:9", cells: [c(8)] }, { label: "FinBox:b3", cells: [] }] }), "Sashimi只表示"],
  ["Sashimi Jellyfish", base({ kind: "FinnedJellyfish", title: "Sashimi Jellyfish", candidates: [4], cells: [c(0), c(8), c(27), c(31), c(54), c(58), c(72), c(76)], actions: [], eliminations: [elim(17, [4])], groups: [{ label: "Branch:Sashimi", cells: [] }, { label: "Base:r1479", cells: [] }, { label: "Cover:c1597", cells: [] }, { label: "FishBody:4", cells: [c(0), c(27), c(31), c(54), c(58), c(72), c(76)] }, { label: "Fin:4", cells: [c(8)] }, { label: "FinBox:b3", cells: [] }] }), "Sashimi只表示"],
];
...
const phase2StructureWingCases = [
  ["Skyscraper row", base({ kind: "Skyscraper", title: "Skyscraper", candidates: [5], cells: [c(0), c(4), c(36), c(40)], actions: [], eliminations: [elim(13, [5])], groups: [{ label: "Branch:Row-Based", cells: [] }, { label: "BaseA:r1", cells: [] }, { label: "BaseB:r5", cells: [] }, { label: "Roofs:5", cells: [c(0), c(40)] }, { label: "LinkedSide:5", cells: [c(4), c(36)] }] }), "两个楼顶至少一个为真"],
...
for (const [name, step, expectedZh] of phase2StructureWingCases) {
  ...
  assert.equal(guide?.length, 6, `${name}: guide does not have six fields`);
  const firstScreen = [payload.structure, payload.principle, payload.deduction, ...guide.slice(0, 3)].join("\n");
  assert.doesNotMatch(firstScreen, /[∨⇒¬⋃]/, `${name}: first screen must use human prose instead of formal symbols`);
  const zhText = [payload.structure, payload.principle, payload.deduction, ...(payload.checks || []), ...guide].join("\n");
  assert.ok(zhText.includes(expectedZh), `${name}: missing marker ${expectedZh}\n${zhText}`);
  const enPayload = buildAuditedStepExplanationPayload(step, "en");
  const enGuide = buildAuditedTechniqueGuide(step, "en");
...
const phase3Cases = [
  ...
  ["Finned Franken Swordfish", base({ kind: "ComplexSwordfish", title: "Complex Swordfish", description: "Finned Franken Swordfish: 4r14b5\\c258 f r5c46 => r5c2<>4", candidates: [4], cells: [c(0), c(4), c(31), c(39), c(40)], actions: [], eliminations: [elim(37, [4])], groups: [{ label: "Branch:Finned Franken", cells: [] }, { label: "FishDigit:4", cells: [] }, { label: "Base:r14b5", cells: [c(0), c(4), c(31), c(39), c(40)] }, { label: "Cover:c258", cells: [c(1), c(4), c(7), c(37), c(40), c(43)] }, { label: "FishBody:4", cells: [c(0), c(4), c(31), c(40)] }, { label: "RegFins:4", cells: [c(39)] }, { label: "Targets:4", cells: [c(37)] }] }), "分两案看"],
  ["Sashimi Mutant Jellyfish", base({ kind: "ComplexJellyfish", title: "Complex Jellyfish", description: "Sashimi Mutant Jellyfish", candidates: [6], cells: [c(0), c(4), c(10), c(30), c(40)], actions: [], eliminations: [elim(22, [6]), elim(40, [6])], groups: [{ label: "Branch:Sashimi Mutant", cells: [] }, { label: "FishDigit:6", cells: [] }, { label: "Base:r1c5b4b8", cells: [c(0), c(4), c(10), c(30), c(40)] }, { label: "Cover:r7c2b2b5", cells: [c(4), c(10), c(22), c(40)] }, { label: "FishBody:6", cells: [c(0), c(10), c(30)] }, { label: "RegFins:6", cells: [c(4)] }, { label: "EdoFins:6", cells: [c(40)] }, { label: "Targets:6", cells: [c(22)] }, { label: "CannibalTargets:6", cells: [c(40)] }] }), "Mutant允许同一侧同时混用行、列、宫"],
...
phase4Cases.push(
  ...
  ["ALS-XZ double RCC", phase4Step("ALSXZ", "ALS-XZ", "Double-RCC Rank-0", [g("AlsA", [c(0), c(1)], "1/3/7"), g("AlsB", [c(9), c(10)], "2/3/7"), g("Rcc", [], "3/7"), g("CannibalTargets", [c(1)], "7")], [3, 7]), "双 RCC 分支不能再套单Z删数解释"],
  ...
  ["ALS-XY-Wing triple linked", phase4Step("ALSXYWing", "ALS-XY-Wing", "Triple-Linked Rank-0", [g("AlsA", [c(0)], "1/3"), g("AlsB", [c(9)], "2/3"), g("AlsC", [c(1), c(10)], "1/2/3"), g("RccX", [], "1"), g("RccY", [], "2"), g("RccZ", [], "3")], [1, 2, 3]), "不是“普通ALS-XY-Wing再多送一些删数”"],
  ["ALS-W-Wing standard", phase4Step("ALSWWing", "ALS-W-Wing", "Standard", [g("AlsA", [c(0), c(1)], "1/5"), g("AlsB", [c(9), c(10)], "1/5"), g("StrongLink", [c(2), c(11)], "1"), g("Z", [], "5")], [1, 5]), "把连接数字看成二选一"],
  ...
  ["ALS-W-Wing rank zero", phase4Step("ALSWWing", "ALS-W-Wing", "Grouped Rank-0", [g("AlsA", [c(0), c(1)], "1/5"), g("AlsB", [c(9), c(10)], "1/5"), g("StrongLink:1@r1", [c(2), c(11)], "1"), g("StrongLink:5@b2", [c(12), c(13)], "5"), g("ResidualDigits", [], "2/3/4")], [1, 5]), "不要求存在单一共同Z"],
  ...
  ["AHS-XY-Wing event logic", phase4Step("AHSXYWing", "AHS-XY-Wing", "Event-RCC", [
    ...
    g("Targets", [c(35)], "4")
  ], [1, 2, 4, 5, 7, 8]), "两条RCC都是AHS的额外格事件析取"],
  ["AHS-XY-Wing triple linked rank zero", phase4Step("AHSXYWing", "AHS-XY-Wing", "Triple-Linked Rank-0", [
    ...
    g("Targets", [c(3)], "7")
  ], [1, 2, 3, 4, 5, 6, 7]), "不能因外翼有一个重叠格就直接标三重链接"],
  ...
  ["Sue de Coq cannibal", phase4Step("SueDeCoq", "Cannibalized Sue de Coq", "Cannibalized", [g("ActiveSector", [c(0), c(1)], "1/2/3"), g("SueB", [c(9), c(10)], "1/2"), g("SueL", [c(18)], "2/3"), g("CannibalTargets", [c(1)], "2")], [1, 2, 3]), "自噬型分支要单独显示"],
);

for (const [branch, marker] of [
  ["Dual ER", "空矩形连接"], ["Dual S-Wing", "对角双值桥"], ["Triple", "三个烟花数字"],
  ["Quadruple", "四数字闭合容量"], ["Dual ALP", "中心双值近锁定数对枢轴"],
  ["Dual W-Wing", "两个同候选双值格"], ["Exocet", "两格双值基准格"],
]) {
...
for (const [branch, marker, extraGroups = []] of [
  ["Type 1", "单个额外候选是唯一破坏点"],
  ["Type 2", "同一个守护数字"],
  ["RT + Triplet Lock Set", "RT与三数组容量合并"],
  ["RT + Triplet ERI", "RT通过ERI传递"],
  ["Almost Fireworks + Type 1 RT", "占住Triplet的两个位置", [g("AFWTripletSlots", [c(27), c(32)], "1/2/3"), g("EscapeCell", [c(47)], "6")]],
  ["Almost Fireworks + Type 2", "两种方式", [g("AFWTripletSlots", [c(27), c(32)], "1/2/3"), g("AFWRemoteTripletPair", [c(9), c(14)], "1/2/3"), g("AFWWitness", [c(16)], "2/3"), g("AFWBaseHouse", [], "r4"), g("AFWCrossHouse", [], "c8"), g("AFWCrossBox", [], "b6"), g("Guardians", [c(47), c(48)], "6")]],
]) {
  phase4Cases.push([`Triplet Oddagon ${branch}`, phase4Step("TripletOddagon", `Triplet Oddagon ${branch}`, branch, [g("TripletBody", Array.from({length:12}, (_,i)=>c(i)), "1/2/3"), g("Targets", [c(20)], "4"), ...extraGroups], [1,2,3,4]), marker]);
}
...
const phase5Step = (kind, title, form, groups = [], candidates = [5]) => base({
  ...
  groups: [
    ...
    { label: `NodeKinds:${kind === "GroupedAIC" ? "Single=1,Grouped=1,ALS=0" : "Single=2,Grouped=0,ALS=0"}`, cells: [] },
...
const phase5Cases = [
  ...
  ["AIC Type 2", (() => { const x = phase5Step("AIC", "AIC Type 2", "OpenChain", [], [4, 7]); x.groups = x.groups.map((q) => q.label === "EndpointRelation:SameDigit" ? { ...q, label: "EndpointRelation:DifferentDigit" } : q); return x; })(), "同时把起点候选排除"],
  ...
  ["H-Wing by AIC", phase5Step("AIC", "H-Wing", "Wing", [{ label: "StrongPattern:VVL", cells: [] }, { label: "ThreeStrongClass:H", cells: [] }], [2, 5, 8]), "两个双值格强边加一个位置强边构成H型"],
